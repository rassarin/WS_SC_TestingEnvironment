...
#Step 4: trimming weather file (WTD/WTDE) files into yearly data file (WTH)
#   Input WTD/WTDE file
#   Output directory is wtdDir
#   Output ex. 00011201.WTH -> the first 4 digits are scenario No., next 2 digits are YY and the last 2 digits are sequent
os.system(r"./exportPHNT.a -d " +wthDir +" " +outputDir+"/"+stationMetadata +" " +outputDir+"/"+locationName+"????."+weatherExtension)
print("running exportPHNT program")
print(r"./exportPHNT.a -d " +wthDir +" " +outputDir+"/"+stationMetadata +" " +outputDir+"/"+locationName+"????."+weatherExtension)